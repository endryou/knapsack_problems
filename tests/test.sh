...
#MKP
$PROJECT_ROOT/bin/run MKP branchAndBound $PROJECT_ROOT/datasets/mkp/01/items --knapsacksPath=$PROJECT_ROOT/datasets/mkp/01/knapsacks --backtracks=10
$PROJECT_ROOT/bin/run MKP greedy $PROJECT_ROOT/datasets/mkp/01/items --knapsacksPath=$PROJECT_ROOT/datasets/mkp/01/knapsacks

#MKP
$PROJECT_ROOT/bin/run MKP branchAndBound $PROJECT_ROOT/datasets/mkp/02/items --knapsacksPath=$PROJECT_ROOT/datasets/mkp/02/knapsacks --backtracks=10
